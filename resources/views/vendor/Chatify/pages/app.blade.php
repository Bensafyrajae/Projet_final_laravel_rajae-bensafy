        ...
        <div class="hidden sm:flex sm:ml-auto sm:mr-3">
            ...
            @if($user->teams_created < 5)
                ...
                <button type="button" onclick="addTeamModal.show()"
                    class="flex justify-center items-center px-4 py-2 gap-2 bg-blue-600 hover:bg-blue-500 text-white rounded-md font-bold text-sm tracking-wide transition-all duration-200 ease-in-out">
